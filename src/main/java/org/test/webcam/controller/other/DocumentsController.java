...
//			BufferedImage image = ImageIO.read(imageFile); 
	...
	/*
	private void fileLogic(DocDocuments image, byte[] bytes) {
	...
	*/
	/*
	private DocDocuments dataLogic(SasUser sasUser, CommonsMultipartFile file) {
		DocDocuments docDocuments = new DocDocuments();
		docDocuments.setLabel(UUID.randomUUID().toString() + "." + FilenameUtils.getExtension(file.getOriginalFilename()));
		docDocuments.setContenttype(file.getContentType());
		docDocuments.setOriginalfilename(file.getOriginalFilename());
		docDocuments.setExtension(FilenameUtils.getExtension(file.getOriginalFilename()));
		docDocuments.setSize(new Long(file.getSize()).toString());
		docDocuments.setPath(filesSettings.getDocumentsDefaultPath() + "/" + docDocuments.getLabel());
		docDocuments.setRealfile(true);
		
		docDocuments = docDocumentsService.create(sObjectListner.create(sasUser, docDocuments));
