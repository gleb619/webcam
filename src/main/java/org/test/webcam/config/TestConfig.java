 ...
 */
@ComponentScan({ "kz.taimax.webcam.model.*", "kz.taimax.webcam.util" })
...
//			dataSource.setUrl("jdbc:postgresql://192.168.0.53:5432/webcam");
			dataSource.setUrl("jdbc:postgresql://192.168.1.102:5432/webcam");
...
//		properties.setProperty("hibernate.hbm2ddl.auto", "create-drop");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "kz.taimax.webcam.model" });
