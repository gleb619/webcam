...
import org.test.webcam.model.dao.secure.UserDao;
...
public class MyUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		org.test.webcam.model.domain.entity.secure.User user = null;
		try {
	 ...
	 * @return the user
	 */
	private User buildUserForAuthentication(org.test.webcam.model.domain.entity.secure.User user,
...
//            System.out.println(user);
	...
	*/
	...
	public UserDetails loadUserByUsername(final String username)
		...
		kz.taimax.tourism.model.domain.entity.secure.User user = null;
		try {
			user = userDao.findByUserName(username);
		} catch (DataAccessException  e) {
			throw new UsernameNotFoundException("Invalid login", e);
	...
	private User buildUserForAuthentication(kz.taimax.tourism.model.domain.entity.secure.User user,
			List<GrantedAuthority> authorities) {
