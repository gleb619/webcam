...
public class TokenUserService {
	...
	public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException {
		org.test.webcam.model.domain.entity.secure.User user = userDao
	...
	public UserDetails loadUserByToken(final String token) throws UsernameNotFoundException {
		org.test.webcam.model.domain.entity.secure.User user = userDao.findByToken(token);
		if (user != null) {
			List<GrantedAuthority> authorities = buildUserAuthority(user
					.getUserRole());
	...
	private User buildUserForAuthentication(
			org.test.webcam.model.domain.entity.secure.User user,
