 ...
 * 
 */
package org.test.webcam.model.domain.entity.secure;
...
public class SasUser extends User implements UserDetails {
	...
	/** The user. */
	private org.test.webcam.model.domain.entity.secure.User user;
	 ...
	 * @return the user
	 */
	public org.test.webcam.model.domain.entity.secure.User getUser() {
		return user;
	}
	 ...
	 */
	public void setUser(org.test.webcam.model.domain.entity.secure.User user) {
		this.user = user;
	}
