...
/**
 * SizedPolyticView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="sized_polytic_view")
public class SizedPolyticView extends SView  {

	private static final long serialVersionUID = 7944434619366651L;
	...
	public SizedPolyticView() {
	}

	public SizedPolyticView(Integer id, Integer version, String name,
			Integer size, String createdby, Date createon, Integer firm,
	...
	@JoinColumn(name="sizedpolyticid")
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SizedPolyticView))
			return false;
		SizedPolyticView castOther = (SizedPolyticView) other;
...
// ------------------ Logic part ------------------
	...
	public SizedPolyticView customInitList(List<String> list) {
	...
	public SizedPolyticView initList() {
		initLists(paymentPolytics);

		return this;
	}
	
	public SizedPolyticView initDicts() {
		return this;
	}
