...
/**
 * SettingsView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="settings_view")
public class SettingsView extends SView  {

	private static final long serialVersionUID = 3727811937596736L;
	...
	public SettingsView(Integer id, Integer version, String name,
			String value, String createdby, Date createon, Integer firm,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SettingsView))
			return false;
		SettingsView castOther = (SettingsView) other;
...
// ------------------ Logic part ------------------
	...
	public SettingsView customInitList(List<String> list) {
	...
	public SettingsView initList() {
		initLists(relUserSettingses);

		return this;
	}
	
	public SettingsView initDicts() {
		return this;
	}
