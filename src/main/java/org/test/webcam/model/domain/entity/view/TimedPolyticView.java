...
/**
 * TimedPolyticView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="timed_polytic_view")
public class TimedPolyticView extends SView  {

	private static final long serialVersionUID = 4644298436928986L;
	...
	private List<PaymentPolyticView> paymentPolytics = new LinkedList<PaymentPolyticView>();
	
	public TimedPolyticView() {
	}

	public TimedPolyticView(Integer id, Integer version, String name,
			Integer numberofdays, String createdby, Date createon,
	...
	@JoinColumn(name="timedpolyticid")
	public List<PaymentPolyticView> getPaymentPolytics() {
		return this.paymentPolytics;
	}

	public void setPaymentPolytics(List<PaymentPolyticView> paymentPolytics) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TimedPolyticView))
			return false;
		TimedPolyticView castOther = (TimedPolyticView) other;
		...
		return ((this.getId() == castOther.getId()) || (this.getId() != null
				...
				&& ((this.getNumberofdays() == castOther.getNumberofdays()) || (this
						.getNumberofdays() != null
						&& castOther.getNumberofdays() != null && this
						.getNumberofdays().equals(castOther.getNumberofdays())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getNumberofdays() == null ? 0 : this.getNumberofdays()
						.hashCode());
		result = 37 * result
...
// ------------------ Logic part ------------------
	...
	public TimedPolyticView customInitList(List<String> list) {
		if (list.contains("paymentPolytics")) {
			initLists(paymentPolytics);
		}
		return this;
	}
	
	public TimedPolyticView initList() {
		initLists(paymentPolytics);

		return this;
	}
	
	public TimedPolyticView initDicts() {
		return this;
	}
