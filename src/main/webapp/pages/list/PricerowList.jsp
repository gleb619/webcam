...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedPriceRow, 'col-md-12': !details.isCollapsedPriceRow }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedPriceRow = !details.isCollapsedPriceRow">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedPriceRow"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedPriceRow"></i>
			</button>
			<div ng-hide="details.isCollapsedPriceRow">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/pricerow?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
					<a href="../data/pricerowview?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA FOR VIEW
					</a>
				</div>
			</c:if>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedPriceRow, 'col-md-12': !details.isCollapsedPriceRow }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailPriceRow, 'scrollable-content-65': !details.isDetailPriceRow }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataPriceRow()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredPriceRow = ( dataPriceRow | filter:searchKeywordPriceRow | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordPriceRow = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredPriceRow.length }} / {{ dataPriceRow.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordPriceRow = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataPriceRow()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataPriceRow()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataPriceRow()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailPriceRow = !details.isDetailPriceRow">
					Detail
				</button>
  			</div>
		</div>
