...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedTransferRoute, 'col-md-12': !details.isCollapsedTransferRoute }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedTransferRoute = !details.isCollapsedTransferRoute">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedTransferRoute"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedTransferRoute"></i>
			</button>
			<div ng-hide="details.isCollapsedTransferRoute">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/transferroute?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedTransferRoute, 'col-md-12': !details.isCollapsedTransferRoute }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailTransferRoute, 'scrollable-content-65': !details.isDetailTransferRoute }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataTransferRoute()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredTransferRoute = ( dataTransferRoute | filter:searchKeywordTransferRoute | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordTransferRoute = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredTransferRoute.length }} / {{ dataTransferRoute.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordTransferRoute = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataTransferRoute()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataTransferRoute()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataTransferRoute()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailTransferRoute = !details.isDetailTransferRoute">
					Detail
				</button>
  			</div>
		</div>
		</div>
	<div class="sector-2" ng-hide="details.isDetailTransferRoute">
		...
		<tabset >
			...
			<tab>
						...
						<jsp:include page="../fragment/list/TransferroutepointFragmentList.jsp"/>
					</tab>
					...
					<tab>
						...
						<jsp:include page="../fragment/list/ReltransferroutepointFragmentList.jsp"/>
					</tab>
					...
					<tab>
						...
						<jsp:include page="../fragment/list/RelservtransfertransferrouteFragmentList.jsp"/>
					</tab>
