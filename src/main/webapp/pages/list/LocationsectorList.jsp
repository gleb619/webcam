...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedLocationSector, 'col-md-12': !details.isCollapsedLocationSector }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedLocationSector = !details.isCollapsedLocationSector">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedLocationSector"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedLocationSector"></i>
			</button>
			<div ng-hide="details.isCollapsedLocationSector">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/locationsector?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedLocationSector, 'col-md-12': !details.isCollapsedLocationSector }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailLocationSector, 'scrollable-content-65': !details.isDetailLocationSector }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataLocationSector()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredLocationSector = ( dataLocationSector | filter:searchKeywordLocationSector | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordLocationSector = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredLocationSector.length }} / {{ dataLocationSector.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordLocationSector = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataLocationSector()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataLocationSector()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataLocationSector()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailLocationSector = !details.isDetailLocationSector">
					Detail
				</button>
  			</div>
		</div>
		</div>
	<div class="sector-2" ng-hide="details.isDetailLocationSector">
		...
		<tabset >
			...
			<tab>
					...
					<tab>
						...
						<jsp:include page="../fragment/list/LocationrowFragmentList.jsp"/>
					</tab>
