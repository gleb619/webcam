...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		...
		<c:if test="${debug}">
			<div class="btn-group">
				<a href="../data/relreqservhoteldocdocumentsforuser?initLists=true&initDicts=true" 		target="_blank" class="btn btn-default"> JSON DATA </a>
				<a href="../data/relreqservhoteldocdocumentsforuserview?initLists=true&initDicts=true" 	target="_blank" class="btn btn-default"> JSON DATA FOR VIEW </a>
			</div>
		</c:if>
		</div>
		<div class="without-padding col-md-12">
			<div class="has-feedback filterBar">
				<input type="text" ng-model="searchKeywordRelReqServHotelDocDocumentsForUser" class="form-control"
					   ng-model-options="{ debounce: 300 }" ng-change="search('filteredRelReqServHotelDocDocumentsForUser', 'dataRelReqServHotelDocDocumentsForUser', 'searchKeywordRelReqServHotelDocDocumentsForUser')"
	...
	<div class="row sector-1">
		<div class="col-md-12 without-padding scrollable-content-65">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataRelReqServHotelDocDocumentsForUser()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<!-- <tr ng-repeat="item in filteredRelReqServHotelDocDocumentsForUser = ( dataRelReqServHotelDocDocumentsForUser | filter:searchKeywordRelReqServHotelDocDocumentsForUser | orderBy: details.sortableColumn: details.sortableReverse )" -->
					<tr ng-repeat="item in filteredRelReqServHotelDocDocumentsForUser track by $index"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordRelReqServHotelDocDocumentsForUser = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredRelReqServHotelDocDocumentsForUser.length }} / {{ dataRelReqServHotelDocDocumentsForUser.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordRelReqServHotelDocDocumentsForUser = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataRelReqServHotelDocDocumentsForUser()">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="loadDataRelReqServHotelDocDocumentsForUser()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-click="loadAllDataRelReqServHotelDocDocumentsForUser()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>
  			</div>
		</div>
