...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div collapse="details.isCollapsedHistoryServHotel" class="col-md-12 without-padding margin-bottom-5">
			<button type="button" class="btn btn-default" ng-click="details.isCollapsedHistoryServHotel = !details.isCollapsedHistoryServHotel">
				<span>X</span>
			</button>
			<div class="btn-group">
		...
		<c:if test="${debug}">
			<a href="../data/historyservhotel?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
				JSON DATA
			</a>
			<a href="../data/historyservhotelview?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
				JSON DATA FOR VIEW
			</a>
		</c:if>
		</div>
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailHistoryServHotel, 'scrollable-content-65': !details.isDetailHistoryServHotel }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataHistoryServHotel()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredHistoryServHotel = ( dataHistoryServHotel | filter:searchKeywordHistoryServHotel | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordHistoryServHotel = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredHistoryServHotel.length }} / {{ dataHistoryServHotel.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li> <a ng-click="searchKeywordHistoryServHotel = ''">Show all</a> </li>
						<li> <a ng-click="sort('createon')">Show last</a> </li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataHistoryServHotel()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li> <a ng-disabled="scrollable.dataLoading">Load more</a> </li>
						<li> <a>Load all</a> </li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailHistoryServHotel = !details.isDetailHistoryServHotel">
					Detail
				</button>
  			</div>
		</div>
		</div>
	<div class="sector-2" ng-hide="details.isDetailHistoryServHotel">
