...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedRelBookingItems, 'col-md-12': !details.isCollapsedRelBookingItems }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedRelBookingItems = !details.isCollapsedRelBookingItems">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedRelBookingItems"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedRelBookingItems"></i>
			</button>
			<div ng-hide="details.isCollapsedRelBookingItems">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/relbookingitems?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedRelBookingItems, 'col-md-12': !details.isCollapsedRelBookingItems }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailRelBookingItems, 'scrollable-content-65': !details.isDetailRelBookingItems }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataRelBookingItems()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredRelBookingItems = ( dataRelBookingItems | filter:searchKeywordRelBookingItems | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordRelBookingItems = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredRelBookingItems.length }} / {{ dataRelBookingItems.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordRelBookingItems = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataRelBookingItems()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataRelBookingItems()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataRelBookingItems()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailRelBookingItems = !details.isDetailRelBookingItems">
					Detail
				</button>
  			</div>
		</div>
