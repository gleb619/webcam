...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedLocationRow, 'col-md-12': !details.isCollapsedLocationRow }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedLocationRow = !details.isCollapsedLocationRow">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedLocationRow"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedLocationRow"></i>
			</button>
			<div ng-hide="details.isCollapsedLocationRow">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/locationrow?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
					<a href="../data/locationrowview?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA FOR VIEW
					</a>
				</div>
			</c:if>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedLocationRow, 'col-md-12': !details.isCollapsedLocationRow }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailLocationRow, 'scrollable-content-65': !details.isDetailLocationRow }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataLocationRow()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredLocationRow = ( dataLocationRow | filter:searchKeywordLocationRow | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordLocationRow = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredLocationRow.length }} / {{ dataLocationRow.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordLocationRow = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataLocationRow()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataLocationRow()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataLocationRow()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailLocationRow = !details.isDetailLocationRow">
					Detail
				</button>
  			</div>
		</div>
		</div>
	<div class="sector-2" ng-hide="details.isDetailLocationRow">
		...
		<tabset >
			...
			<tab>
						...
						<jsp:include page="../fragment/list/LocationseatFragmentList.jsp"/>
					</tab>
