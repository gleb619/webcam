...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		...
		<c:if test="${debug}">
			<div class="btn-group">
				<a href="../data/photo?initLists=true&initDicts=true" 		target="_blank" class="btn btn-default"> JSON DATA </a>
				<a href="../data/photoview?initLists=true&initDicts=true" 	target="_blank" class="btn btn-default"> JSON DATA FOR VIEW </a>
			</div>
		</c:if>
		</div>
		<div class="without-padding col-md-12">
			<div class="has-feedback filterBar">
				<input type="text" ng-model="searchKeywordPhoto" class="form-control"
					   ng-model-options="{ debounce: 300 }" ng-change="search('filteredPhoto', 'dataPhoto', 'searchKeywordPhoto')"
	...
	<div class="row sector-1">
		<div class="col-md-12 without-padding scrollable-content-65">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataPhoto()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					...
					<tr ng-repeat="item in filteredPhoto track by $index"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordPhoto = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredPhoto.length }} / {{ dataPhoto.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordPhoto = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataPhoto()">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="loadDataPhoto()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-click="loadAllDataPhoto()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>
  			</div>
		</div>
		...
		<div class="row sector-2">
			<img ng-src="../images/{{ selectedItem.label }}">
		</div>
	</div>
