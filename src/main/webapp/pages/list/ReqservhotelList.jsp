			...
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				<thead>
					...
					<c:if test="${debug}">
						...
						<th ng-if="::checkVisibility('hotelcaption')">
							<div ng-click="sort('hotelcaption')" >
								<a class="sortable-column-name"><span><spring:message code="label.hotelCaption" /></span></a>
								<i class="fa" ng-class="{ 'fa-caret-down': details.hotelCaption, 'fa-caret-up': !details.hotelCaption }"></i>
							</div>
						</th>
				...
				<tbody>
					...
					<tr ng-repeat="item in filteredReqServHotel track by $index"
					...
					<c:if test="${debug}">
						...
						<td ng-if="::checkVisibility('hotelcaption')"><label>{{ ::item.hotelcaption }}</label></td>
						<td>
	...
	<div class="row sector-2">
		...
		<div class="col-md-12 margin-top-15">
			<tabset >
					...
					<tab select="initTab('relreqservhoteldocdocumentsforuser', 'fragmentlist')">
						<tab-heading><spring:message code="label.RelReqServHotelDocDocumentsForUser"/></tab-heading>
						
						<div ng-if="templates.relreqservhoteldocdocumentsforuser.fragmentlist.init" ng-include="templates.relreqservhoteldocdocumentsforuser.fragmentlist.url"></div>
					</tab>
					...
					<tab select="initTab('relreqservhoteldocdocumentsforhotel', 'fragmentlist')">
						<tab-heading><spring:message code="label.RelReqServHotelDocDocumentsForHotel"/></tab-heading>
						
						<div ng-if="templates.relreqservhoteldocdocumentsforhotel.fragmentlist.init" ng-include="templates.relreqservhoteldocdocumentsforhotel.fragmentlist.url"></div>
					</tab>
