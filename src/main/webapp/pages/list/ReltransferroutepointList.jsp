...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedRelTransferRoutePoint, 'col-md-12': !details.isCollapsedRelTransferRoutePoint }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedRelTransferRoutePoint = !details.isCollapsedRelTransferRoutePoint">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedRelTransferRoutePoint"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedRelTransferRoutePoint"></i>
			</button>
			<div ng-hide="details.isCollapsedRelTransferRoutePoint">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/reltransferroutepoint?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedRelTransferRoutePoint, 'col-md-12': !details.isCollapsedRelTransferRoutePoint }">
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailRelTransferRoutePoint, 'scrollable-content-65': !details.isDetailRelTransferRoutePoint }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataRelTransferRoutePoint()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredRelTransferRoutePoint = ( dataRelTransferRoutePoint | filter:searchKeywordRelTransferRoutePoint | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordRelTransferRoutePoint = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredRelTransferRoutePoint.length }} / {{ dataRelTransferRoutePoint.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordRelTransferRoutePoint = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataRelTransferRoutePoint()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataRelTransferRoutePoint()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataRelTransferRoutePoint()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailRelTransferRoutePoint = !details.isDetailRelTransferRoutePoint">
