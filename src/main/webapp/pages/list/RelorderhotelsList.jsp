...
<div class="my-container-3 sectors-holder">
	<div class="row sector-header">
		<div class="without-padding margin-bottom-5"
			ng-class="{ 'col-md-1': details.isCollapsedRelOrderHotels, 'col-md-12': !details.isCollapsedRelOrderHotels }">
			<button type="button" class="btn btn-default btn-collapsed" ng-click="details.isCollapsedRelOrderHotels = !details.isCollapsedRelOrderHotels">
				<i class="fa fa-ellipsis-h" ng-show="details.isCollapsedRelOrderHotels"></i>
				<i class="fa fa-times" ng-hide="details.isCollapsedRelOrderHotels"></i>
			</button>
			<div ng-hide="details.isCollapsedRelOrderHotels">
				<div class="btn-group">
			...
			<c:if test="${debug}">
				<div class="btn-group">
					<a href="../data/relorderhotels?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
					<a href="../data/relorderhotelsview?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA FOR VIEW
					</a>
				</div>
			</c:if>
		...
		<div class="without-padding" ng-class="{ 'col-md-11': details.isCollapsedRelOrderHotels, 'col-md-12': !details.isCollapsedRelOrderHotels }">
			<div class="has-feedback filterBar">
				<input type="text" ng-model="searchKeywordRelOrderHotels" class="form-control"
	...
	<div class="sector-1">
		<div class="col-md-12 without-padding"
			ng-class="{ 'scrollable-content-84': details.isDetailRelOrderHotels, 'scrollable-content-65': !details.isDetailRelOrderHotels }">
		  <div class="table-responsive margin-bottom-5 table-body" when-scrolled="loadDataRelOrderHotels()">
			<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
				...
				<tbody>
					<tr ng-repeat="item in filteredRelOrderHotels = ( dataRelOrderHotels | filter:searchKeywordRelOrderHotels | orderBy: details.sortableColumn: details.sortableReverse )"
		...
		<div class="col-md-12 margin-bottom-10">
			<div class="btn-toolbar">
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-default" ng-click="searchKeywordRelOrderHotels = ''">
						<i class="fa fa-list-alt fa-lg"></i>
						<span> <spring:message code="default.total" />: {{ filteredRelOrderHotels.length }} / {{ dataRelOrderHotels.length }} </span>
					</button>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-click="searchKeywordRelOrderHotels = ''"><spring:message code="default.ShowAll" /></a></li>
						<li><a ng-click="sort('createon', false)"><spring:message code="default.ShowLast" /></a></li>
					</ul>
				</div>
				<div class="btn-group" dropdown>
					<button type="button" class="btn btn-primary" ng-click="loadDataRelOrderHotels()" ng-disabled="scrollable.dataLoading">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadDataRelOrderHotels()"><spring:message code="default.loadMore" /></a></li>
						<li><a ng-disabled="scrollable.dataLoading" ng-click="loadAllDataRelOrderHotels()"><spring:message code="default.loadAll" /></a></li>
					</ul>
				</div>

  				<button type="button" class="btn btn-default" data-toggle="button"
					ng-click="details.isDetailRelOrderHotels = !details.isDetailRelOrderHotels">
