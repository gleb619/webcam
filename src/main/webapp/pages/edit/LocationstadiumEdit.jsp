	...
	<div ng-hide="loading">
		<div class="modal-header header" cdraggable movable-id="modal-body">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.LocationStadium" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/locationstadium/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
		...
		<div class="modal-body padding-top-0">
			<tabset type="pills"> 
			  ...
			  <tab>
						...
						<jsp:include page="../fragment/ledit/LocationsectorFragmentLedit.jsp" />
					</tab>
