	...
	<div ng-hide="loading">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/relordergift/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
			  ...
			  <tab> 
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('tmorder', 'TmOrder', 'relordergift', dataTmOrder)">
						...
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('tmorder', 'TmOrder', 'relordergift', dataTmOrder)">
				...
				<div class="form-group margin-top-5" ng-show="checkVisibility('servgifts')">
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('servgifts', 'ServGifts', 'relordergift', dataServGifts)">
								<i class="fa fa-plus"></i>
							</button>
						</span>
						...
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('servgifts', 'ServGifts', 'relordergift', dataServGifts)">
								<i class="fa fa-search"></i>
							</button>
						</span>
					</div>
