	...
	<div ng-hide="loading">
		<div class="modal-header header" cdraggable movable-id="modal-body">
			...
			<h4 class="modal-title">
				...
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/appticket/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
		...
		<div class="modal-body padding-top-0">
			<tabset type="pills"> 
			  <tab> 
				...
				<div class="col-md-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-show="checkVisibility('locationseat')">
						...
						<select class="form-control"
										id="selectdictLocationSeat" ng-model="item.locationseat"
					...
					<div class="form-group margin-top-5" ng-show="checkVisibility('barcode')">
						...
						<input type="number" ng-model="item.barcode"
							class="form-control"
							tabindex="5" />
					</div>
				</div>
			  ...
			  <tab>
						...
						<jsp:include page="../fragment/ledit/RelpurchaseitemsFragmentLedit.jsp" />
					</tab>
