	...
	<div ng-hide="loading">
		<div class="modal-header header" cdraggable movable-id="modal-body">
			...
			<h4 class="modal-title">
				...
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/relservtransfertransferroute/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
			  ...
			  <tab> 
				...
				<div class="col-md-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-show="checkVisibility('servtransfer')">
						...
						<select class="form-control"
										id="selectdictServTransfer" ng-model="item.servtransfer"
