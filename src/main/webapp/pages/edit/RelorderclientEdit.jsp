	...
	<div ng-hide="loading">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/relorderclient/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
			  ...
			  <tab> 
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('tmorder', 'TmOrder', 'relorderclient', dataTmOrder)">
						...
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('tmorder', 'TmOrder', 'relorderclient', dataTmOrder)">
				...
				<div class="form-group margin-top-5" ng-show="checkVisibility('tmcontact')">
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('tmcontact', 'TmContact', 'relorderclient', dataTmContact)">
								<i class="fa fa-plus"></i>
							</button>
						</span>
						...
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('tmcontact', 'TmContact', 'relorderclient', dataTmContact)">
								<i class="fa fa-search"></i>
							</button>
						</span>
					</div>
