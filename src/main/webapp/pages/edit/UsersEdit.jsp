	...
	<div ng-if="!loading" class="edit-form-body">
		...
		<div class="modal-body padding-top-0">
			<tabset type="pills"> 
			  <tab> 
				...
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('firstname')">
						...
						<input type="text" ng-model="item.firstname" class="form-control" tabindex="3" />
					</div>

					<div class="form-group margin-top-5" ng-if="::checkVisibility('landingpage')">
						<label><spring:message code="label.landingpage" /></label>
						<input type="text" ng-model="item.landingpage" class="form-control" tabindex="4" />
					</div>

					<div class="form-group margin-top-5" ng-if="::checkVisibility('activationkey')">
						<label><spring:message code="label.activationkey" /></label>
						<input type="text" ng-model="item.activationkey" class="form-control" tabindex="5" />
					</div>

					<div class="form-group margin-top-5" ng-if="::checkVisibility('lastname')">
						<label><spring:message code="label.lastname" /></label>
						<input type="text" ng-model="item.lastname" class="form-control" tabindex="6" />
					</div>
				</div>
			
				<div class="col-md-6 col-lg-4 edit-block">
						
					<div class="form-group margin-top-5" ng-if="::checkVisibility('token')">
						<label><spring:message code="label.token" /></label>
						<input type="text" ng-model="item.token" class="form-control" tabindex="7" />
					</div>
			  ...
			  <tab select="initTab('relusersettings', 'fragmentledit')">
						<tab-heading><spring:message code="label.RelUserSettings"/></tab-heading>
						
						<div ng-if="templates.relusersettings.fragmentledit.init" ng-include="templates.relusersettings.fragmentledit.url"></div>
					</tab>
