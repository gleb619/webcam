	...
	<div ng-hide="loading">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.RelOrderHotels" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/relorderhotels/{{ item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
			  ...
			  <tab> 
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('tmorder', 'TmOrder', 'relorderhotels', dataTmOrder)">
						...
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('tmorder', 'TmOrder', 'relorderhotels', dataTmOrder)">
				...
				<div class="form-group margin-top-5" ng-show="checkVisibility('servhotel')">
					...
					<div class="input-group combobox-holder">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-add" type="button"
								ng-click="addDict('servhotel', 'ServHotel', 'relorderhotels', dataServHotel)">
								<i class="fa fa-plus"></i>
							</button>
						</span>
						<input type="text" ng-model="item.servhotel" combobox="dataServHotel">
						<span class="input-group-btn">
							<button class="btn btn-default combobox-holder-search" type="button"
								ng-click="searchDict('servhotel', 'ServHotel', 'relorderhotels', dataServHotel)">
								<i class="fa fa-search"></i>
							</button>
						</span>
					</div>
