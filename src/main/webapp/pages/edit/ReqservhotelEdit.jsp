	...
	<div ng-if="!loading" class="edit-form-body">
		...
		<div class="modal-body padding-top-0">
			<tabset type="pills"> 
			  ...
			  <tab select="initTab('relreqservhoteldocdocumentsforuser', 'fragmentledit')">
						<tab-heading><spring:message code="label.RelReqServHotelDocDocumentsForUser"/></tab-heading>
						
						<div ng-if="templates.relreqservhoteldocdocumentsforuser.fragmentledit.init" ng-include="templates.relreqservhoteldocdocumentsforuser.fragmentledit.url"></div>
					</tab>
					...
					<tab select="initTab('relreqservhoteldocdocumentsforhotel', 'fragmentledit')">
						<tab-heading><spring:message code="label.RelReqServHotelDocDocumentsForHotel"/></tab-heading>
						
						<div ng-if="templates.relreqservhoteldocdocumentsforhotel.fragmentledit.init" ng-include="templates.relreqservhoteldocdocumentsforhotel.fragmentledit.url"></div>
					</tab>
