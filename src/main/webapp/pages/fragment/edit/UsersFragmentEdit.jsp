...
<div class="row">
				...
				<div class="col-md-6 col-lg-4 edit-block-2">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('token')">
						...
						<input type="text" ng-model="item.users.token" class="form-control" tabindex="7" />
					</div>
