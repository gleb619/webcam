	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.Photo" />
			<c:if test="${debug}">
				<a href="../data/photo/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
			...
			<div class="row">
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('path')">
						...
						<input type="text" ng-model="item.path" class="form-control" tabindex="2" />
					</div>
