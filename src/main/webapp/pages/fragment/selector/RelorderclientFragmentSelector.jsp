	...
	<div ng-hide="loading">
		<div class="modal-header">
			...
			<h4 class="modal-title">
				<spring:message code="default.listof" /> <spring:message code="label.RelOrderClient" />
			<h4>
		</div>
		<div class="row modal-body padding-top-0">
			...
			<div class="col-md-12">
				<div class="table-responsive margin-bottom-5 table-body ledit-scroll scrollable-content-500"
					when-scrolled="loadDataRelOrderClient()">
					<table class="table table-hover table-striped table-bordered
						...
						<tbody>
							<tr ng-repeat="item in filteredRelOrderClient = ( dataRelOrderClient | filter:searchKeywordRelOrderClient ) "
				...
				<div class="btn-toolbar">
	  				<div class="btn-group">
						<button type="button" class="btn btn-default">
							...
							<span><spring:message code="default.total" />:{{ selectedItems.length }} / {{ filteredRelOrderClient.length }} / {{ dataRelOrderClient.length }}</span>
						</button>
						<button type="button" ng-disabled="scrollable.dataLoading"
							class="btn btn-primary" ng-click="loadDataRelOrderClient()">
