...
<div class="row">
	<div class="scrollable-content-300">
		<ol class="list-group">
			...
			<li class="list-group-item" ng-show="checkVisibility('fixedallowance')">
			...
			<li class="list-group-item" ng-show="checkVisibility('percentageofallowances')">
			...
			<li class="list-group-item" ng-show="checkVisibility('free')">
				<span class="list-group-item-caption"><spring:message code="label.free" /></span>
				<span class="pull-right">{{ selectedItem.free }}</span>
			</li>
			<li class="list-group-item" ng-show="checkVisibility('starton')">
				<span class="list-group-item-caption"><spring:message code="label.startOn" /></span>
				<span class="pull-right">{{ selectedItem.starton }}</span>
			</li>
			<li class="list-group-item" ng-show="checkVisibility('transferroute')">
				<span class="list-group-item-caption"><spring:message code="label.transferRoute" /></span>
				<span class="pull-right">{{ selectedItem.transferroute.label }}</span>
			</li>
			<li class="list-group-item" ng-show="checkVisibility('sum')">
				<span class="list-group-item-caption"><spring:message code="label.sum" /></span>
				<span class="pull-right">{{ selectedItem.sum }}</span>
			</li>
			<li class="list-group-item" ng-show="checkVisibility('pointfrom')">
			...
			<li class="list-group-item" ng-show="checkVisibility('pointto')">
