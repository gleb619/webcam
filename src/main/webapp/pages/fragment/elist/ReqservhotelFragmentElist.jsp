...
<div class="row">
	<div class="scrollable-content-300">
		<ol class="list-group">
			...
			<li class="list-group-item" ng-if="::checkVisibility('hotelcaption')">
				<span class="list-group-item-caption"><spring:message code="label.hotelCaption" /></span>
				<span class="pull-right">{{ ::selectedItem.hotelcaption }}</span>
			</li>
