...
<div class="row">
	<div class="scrollable-content-300">
		<ol class="list-group">
			...
			<li class="list-group-item" ng-show="checkVisibility('customername')">
				<span class="list-group-item-caption"><spring:message code="label.customerName" /></span>
				<span class="pull-right">{{ selectedItem.customername }}</span>
			</li>
