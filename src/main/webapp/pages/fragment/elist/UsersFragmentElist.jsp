...
<div class="row">
	<div class="scrollable-content-300">
		<ol class="list-group">
			...
			<li class="list-group-item" ng-if="::checkVisibility('token')">
				<span class="list-group-item-caption"><spring:message code="label.token" /></span>
				<span class="pull-right">{{ ::selectedItem.token }}</span>
			</li>
