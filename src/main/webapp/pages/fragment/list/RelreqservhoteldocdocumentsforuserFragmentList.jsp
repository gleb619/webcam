			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.relReqServHotelDocDocumentsForUsers track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredRelReqServHotelDocDocumentsForUser.length }}/{{ selectedItem.relReqServHotelDocDocumentsForUsers.length }}
				</div>
			  </div>
		</div>
	</div>
