...
import org.test.webcam.model.dao.other.LocalizationDao;
...
//		test21("daktsin2");
	...
	private static String testHash(String username) {
		String result = SecurityUtils.hash(username + username);
...
*/
	private static void test() {
		for (int i = 0; i < 5; i++) {
			...
			System.out.println("faker.lorem().fixedString(10): "
					+ faker.lorem().fixedString(10));
			System.out.println("faker.lorem().paragraph(): "
					+ faker.lorem().paragraph());
			System.out.println("faker.lorem().sentence: "
					+ faker.lorem().sentence());
			System.out.println("faker.lorem().words: " + faker.lorem().words());
			System.out.println("faker.lorem().words().get(0): "
					+ faker.lorem().words().get(0));
